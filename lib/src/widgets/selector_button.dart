...
class SelectorButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: selectorConfig.paddingSelectorBtn ?? EdgeInsets.zero,
      decoration: selectorConfig.decorationSelectorBtn,
          ...
          ? countries.isNotEmpty && countries.length > 1
              ? DropdownButtonHideUnderline(
                  child: DropdownButton<Country>(
                    ...
                    dropdownColor: selectorConfig.bgColorSelect,
                    icon: selectorConfig.suffixIconSelectorBtn,
                  ),
                )
              : Item(
                  country: country,
          ...
          : GestureDetector(
              ...
              child: Row(
                ...
                children: [
                  ...
                  selectorConfig.suffixIconSelectorBtn ?? SizedBox(),
                ],
              ),
            ),
    );
  ...
  Future<Country?> showCountrySelectorDialog(BuildContext inheritedContext, List<Country> countries) {
    return showDialog(
      ...
      builder: (BuildContext context) => AlertDialog(
        backgroundColor: selectorConfig.bgColorSelect,
                ...
                return Directionality(
                  ...
                  child: Container(
                    decoration: ShapeDecoration(
                      color: selectorConfig.bgColorSelect ?? Theme.of(context).canvasColor,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.only(
                          topLeft: Radius.circular(12),
                          topRight: Radius.circular(12),
